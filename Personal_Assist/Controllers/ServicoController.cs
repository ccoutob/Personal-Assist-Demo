...
namespace _Personal_Assist_Beta.Controllers
{
    public class ServicoController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Nome,Descricao,Preco,Categoria")] Servico servico)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nome,Descricao,Preco,Categoria")] Servico servico)
        {
            if (id != servico.Id)
            {
                return NotFound();
